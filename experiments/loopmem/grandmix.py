#!/usr/bin/env python3
"""The scaling law at thirty-seven machines: every class, one prompt, one bank.
...
def main(per_class=2, k=2, out="data/custom/grandmix.json"):
