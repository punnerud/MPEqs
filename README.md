...
| **Prefetch (from the token)** | the word predicts its experts | 62.4 % vs 52.7 % for frequency | **+9.7 pp, free** |
...
| 34 problems, 37 machines, driven by a **1B** | 2/34 | **18/34** |
| the same, with five exemplars rewritten as templates | 2/34 | **23/34** |
